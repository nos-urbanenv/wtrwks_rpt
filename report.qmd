...
# Rで文字コードを扱うのは面倒なのでbashで変換しておく。
# data_rawディレクトリのものを変換し、dataディレクトリに格納する
...
図 @ozn_calib_plot の検量線を用いて、各時刻でのメチレンブルー濃度の変化を導出した。pH・オゾン濃度・TOC濃度の実測値と合わせ、以下に結果を示す。
